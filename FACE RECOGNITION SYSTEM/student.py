...
#FIRST IMAGE
        img=Image.open(r"C:\Users\NAGESH GIRI\Desktop\FACE RECOGNITION SYSTEM\images\student (4).jpg")
...
#SECOND IMAGE
        img1=Image.open(r"C:\Users\NAGESH GIRI\Desktop\FACE RECOGNITION SYSTEM\images\student images (4).jpg")
...
#THIRD IMAGE
        img2=Image.open(r"C:\Users\NAGESH GIRI\Desktop\FACE RECOGNITION SYSTEM\images\images (4).jpg")
...
#backgroud image
        ...
        img3=Image.open(r"C:\Users\NAGESH GIRI\Desktop\FACE RECOGNITION SYSTEM\images\images (1).jpg")
...
#Left side label frame
        ...
        img_left=Image.open(r"C:\Users\NAGESH GIRI\Desktop\FACE RECOGNITION SYSTEM\images\images (5).jpg")
...
#current course
        ...
        current_course_frame.place(x=10,y=135,width=700,height=130)
#Department
        ...
        dep_combo["values"]=("Select Department","Computer","IT","AIML","EXTC","Electrical","machanical ")
        dep_combo.current(0)
...
#Class student information
        ...
        class_student_frame.place(x=10,y=270,width=700,height=280)
#student ID
...
#button frame
        ...
        btn_frame1.place(x=0,y=230,width=715,height=30)
#take a photo sample frame
 ...
 #update photo frame
        update_photo_btn=Button(btn_frame1,text="Update photo sample",command=self.generate_dataset,width=37,font=("times new roman",13,"bold"),bg="blue",fg="white")
...
#right side label 
        ...
        img_right=Image.open(r"C:\Users\NAGESH GIRI\Desktop\FACE RECOGNITION SYSTEM\images\download (4).jpg")
...
#==========SEARCH SYSTEM============
        ...
        search_student_frame.place(x=5,y=135,width=710,height=70)

        search_label=Label(search_student_frame,text="Search By:",font=("times new roman",12,"bold"),bg="yellow",fg="black")
        search_label.grid(row=0,column=0,padx=10,pady=5,sticky=W)

        search_combo=ttk.Combobox(search_student_frame,font=("times new roman",12,"bold"),state="readonly",width=15)
        search_combo["values"]=("Select ","Roll No","Phone No","StudentID")
        search_combo.current(0)
        search_combo.grid(row=0,column=1,padx=2,pady=10,sticky=W)

        search_entry=ttk.Entry(search_student_frame,width=15,font=("times new roman",12,"bold"))
        search_entry.grid(row=0,column=2,padx=10,pady=5,sticky=W)


        search_btn=Button(search_student_frame,text="Search",width=12,font=("times new roman",12,"bold"),bg="blue",fg="white")
        search_btn.grid(row=0,column=3)

        showAll_btn=Button(search_student_frame,text="Show All",width=12,font=("times new roman",12,"bold"),bg="blue",fg="white")
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
           messagebox.showerror("Error","All Fields are required",parent=self.root)
            ...
            try:
                conn=mysql.connector.connect(host="localhost",port=3307, username="root",password="root",database="face-recognition")
...
#=========Generate data set or Take photto sample===============

    def generate_dataset(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="name" or self.var_std_id.get()=="":
            messagebox.showerror("Error","All Fields are required",parent=self.root)
        else:
            try:  
                conn=mysql.connector.connect(host="localhost",port=3307,username="root",password="root",database="face-recognition")
                ...
                face_classifier=cv2.CascadeClassifier(r"C:\Users\NAGESH GIRI\AppData\Local\Programs\Python\Python311\Lib\site-packages\cv2\data\haarcascade_frontalface_default.xml")
                ...
                cap=cv2.VideoCapture(1)
                     # agar webcamera open karna rhega to 0 nahi to 1 likh denge other camera ke liye
                img_id=0
                while True:
