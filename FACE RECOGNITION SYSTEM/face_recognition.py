...
#1st IMAGE===================
        img_top=Image.open(r"images\images.jpg")
...
#2nd IMAGE===============
        img_bottom=Image.open(r"images\images (1).jpg")
...
#=========Button===========
        b1=Button(f_lbl,text="Face Recognition",cursor="hand2",font=("times new roman",18,"bold"),bg="yellow",fg="red")
        b1.place(x=350,y=600,width=200,height=40)

        #============ATTENDANCE=========
    def mark_attendance(self,i,r,n,d):
        with open("nagesh.csv","r+",newline="\n") as f:
    ...
    def face_recognition(self):
        ...
        clf=cv2.face.LBPHFaceRecognizer_created()
