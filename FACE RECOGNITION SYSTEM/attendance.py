...
#FIRST IMAGE
        img=Image.open(r"images\ashish.jpg")
...
#SECOND IMAGE
        img1=Image.open(r"images\student images (4).jpg")
...
#=========bg image=====
        img3=Image.open(r"images\download (3).jpg")
        ...
        title_lbl=Label(bg_img,text="ATTENDANCE MANAGEMENT SYSTEM",font=("times new roman",35,"bold"),bg="green",fg="white")
...
#Left side label frame
        ...
        img_left=Image.open(r"images\images (5).jpg")
...
#attendance ID
        ...
        atten_name=ttk.Entry(left_inside_frame,width=22,textvariable=self.var_atten_roll,font="comicsansns 11 bold")
        ...
        atten_name=ttk.Entry(left_inside_frame,textvariable=self.var_atten_dep,width=22,font="comicsansns 11 bold")
...
#button frame
        ...
        btn_frame.place(x=0,y=300,width=715,height=30)
#importcsv button 
